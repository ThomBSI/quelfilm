...
describe('businessMovies :', () => {
    describe('#getBestMovies', () => {
        ...
        const expectedMoviesTitleList = ['Le labyrinthe', 'Amar', 'Cinquante nuances plus claires', 'Thor  Ragnarok', 'Dunkerque', 'Ma vie'];
        const expectedDeirectorNameList = ['Wes Ball', 'Esteban Crespo', 'James Foley', 'Taika Waititi', 'Christopher Nolan', 'Moi'];
        ...
        describe('cas anormaux :', () => {
                ...
                businessMovies.getBestMovies()
                    ...
                    .then((data) => {
                        if (typeof data != 'undefined') {
                            fail('Doit rejetter la promesse si erreur de l\'API');
                        }
                        done();
                    });
            });
            it('Aucun film n\'est retourné par l\'API', (done) => {
                ...
                businessMovies.getBestMovies()
                    ...
                    .then((data) => {
                        if (typeof data != 'undefined') {
                            fail('Doit rejeter la promesse si aucun film n\'est retourné par l\'API');
                        }
                        done();
                    });
            });
